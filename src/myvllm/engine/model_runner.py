...
from myvllm.models.qwen3_moe import Qwen3MoeForCausalLM
...
class ModelRunner:
    def __init__(self, config: dict, rank: int, event: Event | list[Event]):
        ...
        match model_name:
            ...
            case 'Llama-3.2-1B-Instruct' | 'Llama-3.1-8B-Instruct' | 'Meta-Llama-3.1-8B-Instruct':
